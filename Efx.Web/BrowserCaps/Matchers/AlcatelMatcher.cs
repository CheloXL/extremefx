...
// Type: Efx.Web.BrowserCaps.Matchers.AlcatelMatcher
...
{
  internal sealed class AlcatelMatcher : MatcherBase
  {
    public AlcatelMatcher(IUserAgentNormalizer userAgentNormalizer)
    ...
    {
      if (!request.StartsWith("Alcatel"))
        return request.StartsWith("ALCATEL");
      return true;
    }
