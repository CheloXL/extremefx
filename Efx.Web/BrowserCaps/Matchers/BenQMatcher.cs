...
// Type: Efx.Web.BrowserCaps.Matchers.BenQMatcher
...
{
  internal sealed class BenQMatcher : MatcherBase
  {
    public BenQMatcher(IUserAgentNormalizer userAgentNormalizer)
    ...
    {
      if (!request.StartsWith("BenQ"))
        return request.StartsWith("BENQ");
      return true;
    }
