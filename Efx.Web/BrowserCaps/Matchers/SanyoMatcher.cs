...
// Type: Efx.Web.BrowserCaps.Matchers.SanyoMatcher
...
{
  internal sealed class SanyoMatcher : MatcherBase
  {
    public SanyoMatcher(IUserAgentNormalizer userAgentNormalizer)
    ...
    {
      if (!request.StartsWith("Sanyo"))
        return request.StartsWith("SANYO");
      return true;
    }
