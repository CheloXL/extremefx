...
// Type: Efx.Web.BrowserCaps.Matchers.ToshibaMatcher
...
{
  internal sealed class ToshibaMatcher : MatcherBase
  {
    public ToshibaMatcher(IUserAgentNormalizer userAgentNormalizer)
    ...
    {
      return request.StartsWith("Toshiba");
    }
